...
async function main() {
    consolePort.clear();
    consolePort.log(chalkPort.blue(`Spelling Bee -- CLI Daily Puzzle\n`));
    ...
    consolePort.log(chalkPort.blue('Spelling Bee game coming soon!\n'));
    consolePort.log('Visit the CLI version for now: node SpellingBee/SpellingBee.js\n');
}
